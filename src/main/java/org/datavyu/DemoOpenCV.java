...
public class DemoOpenCV {
    public static void main(String[] args) throws Exception {
        ...
        File file = new File("/Users/redanezzar/Databrary/datavyu-incubator/src/main/resources/DatavyuSampleVideo.mp4");
        if (args.length > 0) {
...
//            File file = Loader.extractResource(url, null, "classifier", ".xml");
            file = new File("/Users/redanezzar/Databrary/datavyu-incubator/src/main/resources/DatavyuSampleVideo.mp4");
//            file.deleteOnExit();
